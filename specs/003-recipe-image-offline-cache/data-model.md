...
Корень: `Library/Application Support/RecipeImages/` (через `FileManager.applicationSupportDirectory`). Ранее — `Caches/`; one-time migration при первом обращении (spec 045).
