...
enum AccessibilityIdentifiers {
    ...
    static let vkusvillBuyButton = "vkusvill_buy_button"
    ...
    static let clipboardImportBanner = "clipboard-import-banner"
    static let clipboardImportBannerMessage = "clipboard-import-banner-message"
    static let clipboardImportBannerAction = "clipboard-import-banner-action"
    ...
    static let releaseNotesBanner = "release_notes_banner"
    static let releaseNotesBannerOpen = "release_notes_banner_open"
    static let releaseNotesBannerDismiss = "release_notes_banner_dismiss"
    static let releaseNotesSheet = "release_notes_sheet"
    static let releaseNotesSheetRowPrefix = "release_notes_sheet_row_"
    static let releaseNotesAccountRow = "release_notes_account_row"
