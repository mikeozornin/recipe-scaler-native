...
final class LocalizationConsistencyTests: XCTestCase {
    ...
    func testCriticalKeysResolveInBothLanguages() {
        let keys = [
            ...
            "vkusvill.settings-title",
            "vkusvill.settings-toggle-title",
            "vkusvill.buy-button",
            "vkusvill.assistant-prompt",
            "vkusvill.offline",
            ...
            "recipes.no-title",
            "recipes.no-recipes",
            "recipes.ingredient-icon.choose",
            "recipes.ingredient-icon.picker-title",
            "recipes.ingredient-icon.picker-search-placeholder",
            "recipes.ingredient-icon.picker-clear",
            "recipes.ingredient-icon.placeholder-alt",
            "recipes.ingredient-icon.autodetected",
            "recipes.ingredient-icon-alt",
            "search.recipes",
            "auth.welcome-title",
            ...
            "timer.intent.default-name",
            "timer.intent.intent.title",
            "timer.intent.intent.description",
            "timer.intent.parameter.hours.description",
            "timer.intent.parameter.minutes.description",
            "timer.intent.parameter.name.description",
            "timer.intent.dialog.hours-only",
            "timer.intent.dialog.minutes-only",
            "timer.intent.dialog.hours-and-minutes",
            "timer.intent.error.zero-duration",
            "timer.intent.hours.one",
            "timer.intent.hours.few",
            "timer.intent.hours.many",
            "timer.intent.minutes.one",
            "timer.intent.minutes.few",
            "timer.intent.minutes.many",
            ...
            // MARK: In-app tips / StoreKit
            "account.section.tips",
            "account.tips.loading",
            "account.tips.manage",
            "account.tips.menu",
            "account.tips.monthly",
            "account.tips.one-time",
            "account.tips.purchase-failed",
            "account.tips.purchase-pending",
            "account.tips.restore",
            "account.tips.restore-failed",
            "account.tips.retry",
            "account.tips.unavailable",
            "account.feedback.menu",
            "account.feedback.title",
            "account.feedback.placeholder",
            "account.feedback.attach",
            "account.feedback.attach-photos",
            "account.feedback.attach-files",
            "account.feedback.remove-file",
            "account.feedback.max-files",
            "account.feedback.send",
            "account.feedback.sent",
            "account.feedback.send-failed",
            "account.feedback.rate-limited",
            "account.feedback.invalid",
            "account.feedback.too-large",
